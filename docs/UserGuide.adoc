...
image::bookings/userguide/ReachBookingsManager.png[title="How to reach Booking Manager"]

Shown below is the landing page of the __Booking Manager__.

image::bookings/userguide/BookingsManager.png[title="Overview of Booking Manager user interface"]
...
image::bookings/userguide/InvalidIndexError.png[title="Error shown due to Invalid Index"]
...
image::bookings/userguide/CreateNewBooking.png[title="Overview when `create` a Booking"]
...
image::bookings/userguide/EditTheBooking.png[title="Overview of `edit` of the name of a Booking"]
...
image::bookings/userguide/FinallyBookingsManager.png[title="Overview of the Bookings Manager Screen"]
